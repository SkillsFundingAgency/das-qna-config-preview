...
namespace SFA.DAS.QnA.Config.Preview.Web.ViewModels.Apply
{
    public class PageViewModel
    {
        ...
        public PageViewModel(Guid id, int sequenceNo, int sectionNo, string pageId, Page page, string pageContext, string redirectAction, string returnUrl, List<QnA.Config.Preview.ApplyTypes.ValidationErrorDetail> errorMessages, string summaryLink = "Show")
        {
            Id = id;
        ...
        public List<QnA.Config.Preview.ApplyTypes.ValidationErrorDetail> ErrorMessages { get; set; }

        private void SetupPage(Page page, List<QnA.Config.Preview.ApplyTypes.ValidationErrorDetail> errorMessages)
        {
            Title = page.Title;
        ...
        private string GetMultipleValue(List<Answer> answers, Question question, List<QnA.Config.Preview.ApplyTypes.ValidationErrorDetail> errorMessages)
        {
            if (errorMessages != null && errorMessages.Any())
            {
